      ...
      <section className={styles.second_section}>
        ...
        <div className={styles.benefit_container}>
          ...
          <div className={styles.benefit_text_container}>
            ...
            <p>
              All you need to get started is basic facility info and your normal
              energy bill. This is mixed with 3,344 building models to create a
              custom energy model for your facility.{" "}
            </p>
          </div>
        </div>
        <div className={styles.benefit_container}>
